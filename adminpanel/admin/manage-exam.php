            ...
            <div class="app-page-title">
                <div class="page-title-wrapper">
                     <div class="page-title-heading">
                        <div> Administrar Examen
                            <div class="page-title-subheading">
                              Agregar preguntas para <?php echo $selExamRow['ex_title']; ?>
                            </div>
                        </div>
                    </div>
                </div>
                      ...
                      <div class="main-card mb-3 card">
                          ...
                          <div class="card-body">
                           <form method="post" id="updateExamFrm">
                              ...
                              <div class="form-group">
                                <label>Límite de visualización</label>
                          ...
                          <div class="card-header"><i class="header-icon lnr-license icon-gradient bg-plum-plate"> </i>Preguntas 
                            <span class="badge badge-pill badge-primary ml-2">
                             ...
                             <div class="btn-actions-pane-right">
                                <button class="btn btn-sm btn-primary " data-toggle="modal" data-target="#modalForAddQuestion">Agregar preguntas</button>
                              </div>
                          </div>
                          <div class="card-body" >
